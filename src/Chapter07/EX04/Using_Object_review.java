...
class Person{
	...
	Person (String name, float height){	 // this : 인풋 매개변수명, 값는 받는 변수, 필드명 	
		this.name = name; 
		this.height= height; 
	}
...
public class Using_Object_review {
	...
	public static void main(String[] args) {
		...
		System.out.println(person.age); 
			...
			//getter 를 사용해서 필드 의 내용을 출력 (//필드의 값을 리턴)
